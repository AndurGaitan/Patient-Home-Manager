...
<div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <div className="grid items-center grid-cols-1 md:grid-cols-2">
        <div>
            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Hola 👋 soy <br className="block sm:hidden" />Andrés Gaitán</h2>
        ...
        <div className="relative">
            ...
            <img className="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src={foto} alt="" />
        </div>
    </div>
</div>
</section>
